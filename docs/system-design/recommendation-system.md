...
See [ranking.md](../ranking.md) for parameter defaults.
...
Gap: few tests assert exact rank order with fixed random seed. See [scalability-and-limitations.md](./scalability-and-limitations.md).
