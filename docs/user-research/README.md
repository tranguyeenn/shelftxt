...
| Forgotten context | `why_added` noted as future field in [system-design/data-model.md](../system-design/data-model.md) |
...
Research does **not** automatically become a roadmap commitment. See [feature-opportunities.md](./feature-opportunities.md) and [system-design/future-roadmap.md](../system-design/future-roadmap.md).
...
- [system-design/future-roadmap.md](../system-design/future-roadmap.md) — engineering/product direction informed by themes here
- [opensource.md](../opensource.md) — mission: reading accessibility, less overwhelm
- [system-design/frontend-design.md](../system-design/frontend-design.md) — reader-focused UI principles
